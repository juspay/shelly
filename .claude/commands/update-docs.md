...
1. Review current documentation status:
   - Check implementation status documents for overall project status
   - Review implemented phase documents
   - Examine `CLAUDE.md` and `README.md` for project-wide documentation
   - Check for and document any new lessons learned or best practices
...
2. Analyze implementation and testing results:
   ...
   - Cross-reference updated documentation with recent implementation and test results
...
3. Update CLAUDE.md and README.md if necessary:
...
- DO NOT CREATE new specification files unless necessary
- UPDATE existing files in the documentation directories
